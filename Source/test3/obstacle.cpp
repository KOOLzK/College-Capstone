	...
	:Super(ObjectInitializer)
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &Aobstacle::OnHit);
...
void Aobstacle::OnHit(AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
